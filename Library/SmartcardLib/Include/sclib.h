...
/** @addtogroup NANO103_Library NANO103 Library
  @{
*/

/** @addtogroup NANO103_SCLIB Smartcard Library
  @{
*/

/** @addtogroup NANO103_SCLIB_EXPORTED_CONSTANTS Smartcard Library Exported Constants
  @{
*/
...
#define SCLIB_ERR_CMD                           0x00000006  ///< Command error
#define SCLIB_ERR_UNSUPPORTEDCARD               0x00000007  ///< Unsupported card
#define SCLIB_ERR_READ                          0x00000008  ///< Read error
#define SCLIB_ERR_WRITE                         0x00000009  ///< Write error
...
#define SCLIB_ERR_BGTIMEOUT                     0x0000000E  ///< BGT time error
// error code generate while parsing ATR and process PPS
#define SCLIB_ERR_ATR_UNRECOGNIZED              0x00001001  ///< Unrecognised ATR
...
#define SCLIB_ERR_PPS                           0x00001004  ///< PPS echange error
...
/*@}*/ /* end of group NANO103_SCLIB_EXPORTED_CONSTANTS */

/** @addtogroup NANO103_SCLIB_EXPORTED_STRUCTS Smartcard Library Exported Structs
  @{
*/
...
/*@}*/ /* end of group NANO103_SCLIB_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NANO103_SC_Library */
